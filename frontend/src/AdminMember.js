...
import { FormHelperText, Paper, Table, TableCell, TableContainer, TableHead, TableRow, TableBody } from '@material-ui/core';
          ...
          <TableBody>
            {list.map((el)=>(
              <TableRow key={el._id}>
                ...
                <TableCell align="left">{el.password}</TableCell>
                <TableCell align="left">{el.alamat}</TableCell>
                <TableCell align="left">{el.namaAkun}</TableCell>
