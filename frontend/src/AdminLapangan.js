...
export default function AdminHome() {
        ...
        <Table >
          <TableHead>
            <TableRow>
              ...
              <TableCell>Tanggal Tersedia</TableCell>
              <TableCell>Waktu Sewa</TableCell>
              <TableCell>Ketersediaan</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {list.map((el)=>(
              <TableRow key={el._id}>
                ...
                <TableCell align="left">{el.luas_lapangan}</TableCell>
                <TableCell align="left">{el.hargasewa}</TableCell>
                <TableCell align="left">{el.tanggaltersedia}</TableCell>
                <TableCell align="left">{el.slotWaktu}</TableCell>
                <TableCell align="left">{el.ketersediaan.toString()}</TableCell>
              </TableRow>
            ))}
          </TableBody>
  ...
  return (
    <React.Fragment>
        ...
        <Typography variant="h4" className={classes.sideinfo}>List Lapangan</Typography>
        <LapanganList/>
        <Box mt={5}>
          <Copyright />
        </Box>
